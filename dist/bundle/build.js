...
var app = (function (fs, path, util, events) {
    'use strict';
    ...
    * */
    ...
    var document$1 = freeSelf && freeSelf.document;
    var previousIs = root.is;

    // store navigator properties to use later
    var navigator$1 = freeSelf && freeSelf.navigator;
    var platform = ((navigator$1 && navigator$1.platform) || '').toLowerCase();
    var userAgent = ((navigator$1 && navigator$1.userAgent) || '').toLowerCase();
    var vendor = ((navigator$1 && navigator$1.vendor) || '').toLowerCase();
    ...
    is.online = function () {
      return !navigator$1 || navigator$1.onLine === true
    };
    ...
    is.touchDevice = function () {
      return (
        ...
        ('ontouchstart' in freeSelf ||
          ('DocumentTouch' in freeSelf && document$1 instanceof DocumentTouch))
      )
    };
    ...
    // Local ENV
    config$1({ path: cpath + '/../../../../.env' });

    // Frontier ENV
    config$1({ path: cpath + '/front.env' });

    let args = function (args, opts) {
      if (env.get('FRONT_DEBUG')) ;
      if (!opts) opts = {};
    ...
    */
    ...
    Konsole.prototype.write = function () {
      process.stdout.write(format$1.apply(this, arguments) + '\n');
    };
    Konsole.prototype.format = function () {
      return format$1.apply(this, arguments)
    };
    ...
    let front$1 = (file) => require(__dirname + '/' + file);
    ...
    // Frontier ENV
    config$1({ path: cpath$1 + 'front.env' });
    let Toolbelt = {
      env,
      dotenv: config$1,
      args,
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$b, 54, 4, 1344);
    			attr_dev(form_1, "class", "");
    			add_location(form_1, file$b, 41, 2, 1073);
    			attr_dev(section, "debug", "");
    			attr_dev(section, "class", "bps-debug box _x");
    			add_location(section, file$b, 40, 0, 1030);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div28, "class", "br w_ ");
    			add_location(div28, file$d, 495, 2, 17733);
    			attr_dev(div29, "class", "br w-- ");
    			add_location(div29, file$d, 496, 4, 17766);
    			attr_dev(div30, "class", "br w- ");
    			add_location(div30, file$d, 497, 4, 17801);
    			add_location(button2, file$d, 501, 8, 17890);
    			add_location(div31, file$d, 500, 6, 17876);
    			attr_dev(div32, "class", "br w block x ");
    			add_location(div32, file$d, 498, 4, 17834);
    			attr_dev(div33, "class", "br w+ ");
    			add_location(div33, file$d, 504, 4, 17944);
    			attr_dev(div34, "class", "br w++ ");
    			add_location(div34, file$d, 505, 4, 17977);
    			attr_dev(div35, "class", "br w* ");
    			add_location(div35, file$d, 506, 4, 18012);
    			add_location(button3, file$d, 510, 8, 18104);
    			add_location(div36, file$d, 509, 6, 18090);
    			attr_dev(div37, "class", "br w** block x");
    			add_location(div37, file$d, 507, 4, 18045);
